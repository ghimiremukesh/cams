...
_GAME_TYPE = pyspiel.GameType(
    ...
    long_name="Python Hexner's Game Long Form",
    dynamics=pyspiel.GameType.Dynamics.SIMULTANEOUS,
    chance_mode=pyspiel.GameType.ChanceMode.EXPLICIT_STOCHASTIC,
    information=pyspiel.GameType.Information.IMPERFECT_INFORMATION,
    utility=pyspiel.GameType.Utility.ZERO_SUM,
    reward_model=pyspiel.GameType.RewardModel.TERMINAL,   # set to REWARDS if includes ins. loss
...
class HexnerState(pyspiel.State):
    ...
    def __init__(self, game):
        ...
        super().__init__(game)
        self.states = [np.zeros(8, )]  # initialize positions and velocities
        self.states[0][0] = -0.5  # fix p1 to left of the center
        self.states[0][4] = 0.5   # fix p2 to right of the center
        self.actions = []
        ...
        self._p1type = [0, 0]  # first index represents type -1 and second represents type 1
    ...
    def _terminal_cost(self, states):
        ...
        terminal = np.mean([dist_to_goal_1, dist_to_goal_2]).round(2)
    ...
    def returns(self):
        ...
        if not self._game_over:
            ...
            return self._terminal_cost(self.states[-1])
...
class HexnerObserver:
    ...
    def set_from(self, state, player):
        ...
        if "player_type" in self.dict and player == 0:
            self.dict["player_type"][state._p1type[player]] = 1
    ...
    def string_from(self, state, player):
        ...
        pieces = []
        if "player_type" in self.dict and player == 0:
            pieces.append(f"type:{state._p1type}")
