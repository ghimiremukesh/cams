...
from algorithms.MMD.MMD_Pub_Belief import MMDAgent
...
class Args:
    ...
    save_dir: str = "./saved_models/FINAL/MMD_SIMUL_CONV/1-step"
    ...
    for iteration in tqdm(range(1, args.num_iterations + 1)):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                #     _, means, _, _, post = agent1.model(debug_obs)
                ...
                # backward KL loss -- clamp to make it != 0.
                backward_kl_approx1 = r1 * r1.clamp(min=1e-8).log() - (r1 - 1)
                backward_kl_approx2 = r2 * r2.clamp(min=1e-8).log() - (r2 - 1)

                backward_kl_approx1 = backward_kl_approx1.mean()
                backward_kl_approx2 = backward_kl_approx2.mean()

                ent_kl_coef_mult = np.sqrt(args.total_timesteps/(global_step + 1000)) # following IIG-RL-Benchmark
                loss1 = pg1 - args.ent_coef*ent_loss1 + args.vf_coef*vloss1 + args.kl_coef * ent_kl_coef_mult * backward_kl_approx1
                loss2 = pg2 - args.ent_coef*ent_loss2 + args.vf_coef*vloss2 + args.kl_coef * ent_kl_coef_mult * backward_kl_approx2
        ...
        if iteration % args.print_freq == 0:
            print(f"Iter {iteration}/{args.num_iterations}, "
                  ...
                  # f"P1 Means: {means[0, :, :]}, Posterior: {post}")
        ...
        with torch.no_grad():
            ...
            log_to_csv(log_data, args.save_dir + '/dist_to_gt.csv')
